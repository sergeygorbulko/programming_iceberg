...
fun visitTavern(player: Player) {
    ...
    narrate("patronsGold: $patronGold")
    ...
    displayPatronBalances(patronGold=patronGold, heroName=player.name)
    ...
    narrate(patrons.joinToString())
    narrate(patronGold.keys.joinToString())
}
...
private fun displayPatronBalances(patronGold: Map<String, Double>, heroName: String = "Alex Ironfoot") {
